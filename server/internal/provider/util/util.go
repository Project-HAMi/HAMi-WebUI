...
// DecodePodDevices skips Ascend, which the ascend provider decodes against the device configuration.
...
func supportDevicesForPod(map[string]string) map[string]string {
