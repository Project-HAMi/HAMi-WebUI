export default {
  ...
  task: {
    ...
    statusInfo: {
      legacy: 'The server reports {status}; this API does not provide container status details.',
      summary: {
        waiting: 'The container is waiting to start or restart.',
        success: 'The container is running and ready.',
        not_ready: 'The container is running, but Kubernetes has not marked it ready.',
        error: 'The container encountered a startup, runtime, or restart error. See the reported state below.',
        closed: 'The container exited successfully and is not awaiting an automatic restart.',
        failed: 'The container exited with a failure and is not awaiting an automatic restart.',
        terminating: 'The Pod is being deleted and its containers are being terminated.',
        unknown: 'There is not enough information to determine this container\'s state.',
      },
      containerState: 'Container state',
      containerStates: { Waiting: 'Waiting', Running: 'Running', Terminated: 'Terminated' },
      containerReady: 'Container readiness',
      ready: 'Ready',
      notReady: 'Not ready',
      unknown: 'Unknown',
      ...
      exitCode: 'Exit code',
      restartPending: 'The container will restart according to the Pod restart policy.',
      lastTerminationReason: 'Last termination reason',
      lastExitCode: 'Last exit code',
      lastTerminationMessage: 'Last termination message',
      podPhase: 'Pod phase',
      podReady: 'Pod readiness',
      podReadyReason: 'Pod readiness reason',
      podReadyMessage: 'Pod readiness message',
      podReason: 'Pod reason',
      podMessage: 'Pod message',
      podReadyScope: 'Pod readiness covers the entire Pod and can depend on other containers or readiness gates; it does not mean this container is in error.',
    },
    count: '',
