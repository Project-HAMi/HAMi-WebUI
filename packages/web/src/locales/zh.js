export default {
  ...
  task: {
    ...
    statusInfo: {
      legacy: '服务端报告为{status}，当前接口未提供容器状态详情。',
      summary: {
        waiting: '容器正在等待启动或重启。',
        success: '容器正在运行，且已就绪。',
        not_ready: '容器正在运行，但 Kubernetes 尚未将该容器标记为就绪。',
        error: '容器遇到启动、运行或重启异常，具体原因见下方状态信息。',
        closed: '容器已正常退出，且没有等待自动重启。',
        failed: '容器退出失败，且没有等待自动重启。',
        terminating: 'Pod 正在删除，容器处于终止流程。',
        unknown: '当前信息不足以确认该容器的状态。',
      },
      containerState: '容器状态',
      containerStates: { Waiting: '等待中', Running: '运行中', Terminated: '已退出' },
      containerReady: '容器就绪',
      ready: '已就绪',
      notReady: '未就绪',
      unknown: '未知',
      containerReason: '容器原因',
      containerMessage: '容器消息',
      restartCount: '重启次数',
      exitCode: '退出码',
      restartPending: '容器退出后将按 Pod 重启策略自动重启。',
      lastTerminationReason: '上次退出原因',
      lastExitCode: '上次退出码',
      lastTerminationMessage: '上次退出消息',
      podPhase: 'Pod 阶段',
      podReady: 'Pod 就绪',
      podReadyReason: 'Pod 就绪原因',
      podReadyMessage: 'Pod 就绪消息',
      podReason: 'Pod 原因',
      podMessage: 'Pod 消息',
      podReadyScope: 'Pod 就绪状态涵盖整个 Pod，可能受其他容器或就绪门控影响，不等同于当前容器异常。',
    },
    count: '个',
    card: '算力配置',
    allCards: '全部显卡',
